...
This is not a wrapper around FFmpeg or any other existing codec :) Every step in both the encoder and decoder are implemented from scratch using just tensor operations.
